...
class TVI:
    def __init__(self,a,puissance_a,b,puissance_b,c,puissance_c,d,puissance_d,valeur_chercher,intervalle1,intervalle2,intervalleac):
    ...
    def TVI(self):
        ...
        if (self._chr<=self.fonction(self._r1) and self._signe_segmenttab[0]=="-" and (self.intervalle<self._r1)or self.intervalleb==False) or (self._chr>=self.fonction(self._r1) and self._signe_segmenttab[0]=="+" and (self.intervalle>self._r1)or self.intervalleb==False):
            print("le nombre a pour intervalle ]",self._signe_segmenttab[0],"inf;", self._r1, "]")
            comp+=1
        if  (self._chr<=self.fonction(self._r2) and self._signe_segmenttab[2]=="-"and (self.intervalle<self._r2)or self.intervalleb==False) or (self._chr>=self.fonction(self._r2) and self._signe_segmenttab[2]=="+" and (self.intervalle>self._r2)or self.intervalleb==False):
            print("le nombre a pour intervalle[ ",self._r2, ";", self._signe_segmenttab[2], "inf[")
            comp += 1
        if self.fonction(self._r1)< self.fonction(self._r2) and (((self.intervalle<self._r1)and ((self.intervalle<self._r2)))or self.intervalleb==False):
            ...
            if self._chr>=self.fonction(self._r2) and self._chr<=self.fonction(self._r1) and (((self.intervalle>self._r1)and ((self.intervalle>self._r2)))or self.intervalleb==False):
                print("le nombre a pour intervalle[ ",self._r1, ";", self._r2, "]")
                comp += 1
